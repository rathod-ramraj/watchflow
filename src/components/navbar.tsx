    ...
    >
      <div className="mx-auto flex max-w-[1600px] items-center gap-2 px-4 py-3 sm:gap-3 md:px-6">
        <Link href="/" className="flex shrink-0 items-center gap-2.5 font-bold transition-transform active:scale-95">
          <Image priority src="/favicon-new.png" alt="FMW Logo - Free Media World" width={40} height={40} className="h-10 w-10 sm:h-12 sm:w-12 object-contain" />
          <span className={cn("text-2xl sm:text-3xl font-black tracking-tight bg-gradient-to-r from-[var(--fg)] to-[var(--accent)] bg-clip-text text-transparent", outfit.className)}>FMW</span>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          ...
          {/* Discord */}
          <a
            href="https://discord.gg/Pd7eEPSf4"
            target="_blank"
