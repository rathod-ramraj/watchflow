      ...
      <div className="flex flex-col gap-2.5">
        ...
        <div className="no-scrollbar -mx-3 flex gap-2 overflow-x-auto px-3 pb-1 sm:-mx-4 sm:px-4 md:mx-0 md:flex-wrap md:overflow-visible md:px-0 md:pb-0">
          <button
            ...
            className={cn("watchflow-pill h-8 shrink-0 px-3 text-xs font-semibold")}
          >
            All
          </button>
          {categories.map((c) => {
            ...
            return (
              <button
                ...
                onClick={() => toggle(c.id)}
                className={cn("watchflow-pill inline-flex h-8 shrink-0 items-center gap-1.5 px-3 text-xs font-semibold")}
              >
